...
import { POST as closeJobEvaluation } from "../../app/api/classes/[classId]/job-evaluation/close/route";
import { POST as finalizeJobEvaluation } from "../../app/api/classes/[classId]/job-evaluation/finalize/route";
import { POST as closeMonthlyJobSource } from "../../app/api/classes/[classId]/monthly-job-choice/close/route";
import { POST as startMonthlyJobChoice } from "../../app/api/classes/[classId]/monthly-job-choice/start/route";
  ...
  async fetch(request: Request, environment: TestEnvironment) {
    ...
    try {
      ...
      if (url.pathname === "/classes" && request.method === "POST") {
        ...
        url.pathname === "/classes/class-cash-archive/job-assignments/mode"
        && request.method === "PUT"
      ) {
        ...
        response = await completeInitialAssignments(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
      } else if (
        url.pathname === "/classes/class-cash-archive/monthly-job-choice/complete"
        && request.method === "POST"
      ) {
        response = await completeMonthlyJobChoice(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
      } else if (
        url.pathname === "/classes/class-cash-archive/monthly-job-choice/shuffle"
        && request.method === "POST"
      ) {
        response = await shuffleMonthlyJobChoice(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
      } else if (
        url.pathname === "/classes/class-cash-archive/job-evaluation/open"
        && request.method === "POST"
      ) {
        ...
        url.pathname === "/classes/class-cash-archive/job-evaluation/close"
        && request.method === "POST"
      ) {
        response = await closeJobEvaluation(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
      } else if (
        url.pathname === "/classes/class-cash-archive/job-evaluation/finalize"
        && request.method === "POST"
      ) {
        response = await finalizeJobEvaluation(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
      } else if (
        url.pathname === "/classes/class-cash-archive/monthly-job-choice/close"
        && request.method === "POST"
      ) {
        response = await closeMonthlyJobSource(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
      } else if (
        url.pathname === "/classes/class-cash-archive/monthly-job-choice/start"
        && request.method === "POST"
      ) {
        response = await startMonthlyJobChoice(request, {
          params: Promise.resolve({ classId: "class-cash-archive" }),
        });
