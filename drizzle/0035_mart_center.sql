...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_operations_id_class_uq
  ON mart_operations(id, class_id);
--> statement-breakpoint
CREATE UNIQUE INDEX mart_operations_class_idempotency_uq
  ON mart_operations(class_id, idempotency_key);
--> statement-breakpoint
CREATE INDEX mart_operations_class_created_idx
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_products_id_class_uq ON mart_products(id, class_id);
--> statement-breakpoint
CREATE INDEX mart_products_class_active_idx
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_inventory_product_class_uq
  ON mart_inventory(product_id, class_id);
--> statement-breakpoint
CREATE INDEX mart_inventory_class_quantity_idx
  ON mart_inventory(class_id, quantity);
--> statement-breakpoint
CREATE TABLE mart_product_events (
  id TEXT PRIMARY KEY NOT NULL,
  class_id TEXT NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_product_events_product_revision_uq
  ON mart_product_events(product_id, revision);
--> statement-breakpoint
CREATE UNIQUE INDEX mart_product_events_operation_uq
  ON mart_product_events(operation_id);
--> statement-breakpoint
CREATE INDEX mart_product_events_class_created_idx
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sales_id_class_uq ON mart_sales(id, class_id);
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sales_created_operation_uq
  ON mart_sales(created_operation_id);
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sales_cancelled_operation_uq
  ON mart_sales(cancelled_operation_id)
  WHERE cancelled_operation_id IS NOT NULL;
--> statement-breakpoint
CREATE INDEX mart_sales_class_created_idx
  ON mart_sales(class_id, created_at);
--> statement-breakpoint
CREATE INDEX mart_sales_buyer_created_idx
  ON mart_sales(buyer_student_id, created_at);
--> statement-breakpoint
CREATE TABLE mart_sale_items (
  id TEXT PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sale_items_id_class_uq
  ON mart_sale_items(id, class_id);
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sale_items_sale_product_uq
  ON mart_sale_items(sale_id, product_id);
--> statement-breakpoint
CREATE INDEX mart_sale_items_product_idx
  ON mart_sale_items(product_id, created_at);
--> statement-breakpoint
CREATE TABLE mart_sale_cancellations (
  id TEXT PRIMARY KEY NOT NULL,
  class_id TEXT NOT NULL,
  sale_id TEXT NOT NULL,
  operation_id TEXT NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sale_cancellations_sale_uq
  ON mart_sale_cancellations(sale_id);
--> statement-breakpoint
CREATE UNIQUE INDEX mart_sale_cancellations_operation_uq
  ON mart_sale_cancellations(operation_id);
--> statement-breakpoint
CREATE TABLE mart_inventory_movements (
  id TEXT PRIMARY KEY NOT NULL,
  class_id TEXT NOT NULL,
  product_id TEXT NOT NULL,
  operation_id TEXT NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX mart_inventory_movements_product_revision_uq
  ON mart_inventory_movements(product_id, inventory_revision_after);
--> statement-breakpoint
CREATE INDEX mart_inventory_movements_class_created_idx
  ON mart_inventory_movements(class_id, created_at);
--> statement-breakpoint
CREATE INDEX mart_inventory_movements_operation_idx
  ON mart_inventory_movements(operation_id);
--> statement-breakpoint
CREATE INDEX mart_inventory_movements_sale_idx
  ON mart_inventory_movements(source_sale_id, movement_type);
--> statement-breakpoint
CREATE TRIGGER mart_operations_insert_revision_guard
...
--> statement-breakpoint
CREATE TRIGGER mart_operations_insert_class_guard
BEFORE INSERT ON mart_operations
WHEN NOT EXISTS (
...
--> statement-breakpoint
CREATE TRIGGER mart_operations_insert_teacher_guard
BEFORE INSERT ON mart_operations
...
--> statement-breakpoint
CREATE TRIGGER mart_operations_insert_clerk_guard
BEFORE INSERT ON mart_operations
...
--> statement-breakpoint
CREATE TRIGGER mart_operations_insert_correction_guard
BEFORE INSERT ON mart_operations
...
--> statement-breakpoint
CREATE TRIGGER mart_operations_update_guard
BEFORE UPDATE ON mart_operations
BEGIN SELECT RAISE(ABORT, 'MART_OPERATION_IMMUTABLE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_operations_delete_guard
BEFORE DELETE ON mart_operations
BEGIN SELECT RAISE(ABORT, 'MART_OPERATION_IMMUTABLE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_products_insert_guard
...
--> statement-breakpoint
CREATE TRIGGER mart_products_update_guard
...
--> statement-breakpoint
CREATE TRIGGER mart_inventory_update_guard
...
--> statement-breakpoint
CREATE TRIGGER mart_product_events_update_guard
BEFORE UPDATE ON mart_product_events
BEGIN SELECT RAISE(ABORT, 'MART_PRODUCT_EVENT_IMMUTABLE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_product_events_delete_guard
BEFORE DELETE ON mart_product_events
BEGIN SELECT RAISE(ABORT, 'MART_PRODUCT_EVENT_IMMUTABLE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_sales_insert_guard
...
--> statement-breakpoint
CREATE TRIGGER mart_sale_items_insert_guard
...
--> statement-breakpoint
CREATE TRIGGER mart_inventory_movements_insert_guard
...
BEGIN SELECT RAISE(ABORT, 'MART_INVENTORY_STALE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_inventory_movements_apply
...
BEGIN SELECT RAISE(ABORT, 'MART_SALE_STALE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_sale_cancellations_update_guard
BEFORE UPDATE ON mart_sale_cancellations
BEGIN SELECT RAISE(ABORT, 'MART_SALE_CANCELLATION_IMMUTABLE'); END;
--> statement-breakpoint
CREATE TRIGGER mart_sale_cancellations_delete_guard
